...
```bash
docker pull ghcr.io/hauke-cloud/library/opentofu:latest
```

#### Run the Docker Container

```bash
docker run -d --rm ghcr.io/hauke-cloud/library/opentofu:latest
```
...
```bash
SMEE_IMAGE=ghcr.io/hauke-cloud/library/opentofu:latest
```
